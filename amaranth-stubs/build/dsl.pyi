...
class Pins:
    def __init__(
        ...
        *,
        dir: str = ...,
        invert: bool = ...,
        conn: Optional[tuple[str, int | str]] = ...,
        assert_width: Optional[int] = ...,
    ) -> None: ...
...
class Resource(Subsignal):
    @classmethod
    def family(
        cls, name_or_number: str | int, number: Optional[int] = ..., *, ios, default_name: str, name_suffix: str = ...
    ):  # -> Self@Resource:
        ...
...
class Connector:
    def __init__(
        self, name: str, number: int, io: str | dict[str, str], *, conn: Optional[tuple[str, int | str]] = ...
    ) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[tuple[str, str]]: ...
