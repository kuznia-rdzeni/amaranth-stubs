...
from amaranth.hdl import MemoryInstance

from amaranth_types.types import ShapeLike, ValueLike
from ..hdl import MemoryData
from . import wiring
...
class Memory(wiring.Component):
    ...
    def read_port(self, *, domain: str = ..., transparent_for: Iterable[WritePort] = ..., src_loc_at: int = ...) -> ReadPort:
        """Request a read port.
    ...
    def write_port(self, *, domain: str = ..., granularity: Optional[int] = ..., src_loc_at: int = ...) -> WritePort:
...
class ReadPort:
    ...
    class Signature(wiring.Signature):
        ...
        def create(self, *, path: tuple[str | int, ...] = ..., src_loc_at: int =...) -> ReadPort:
            """:meta private:"""
            ...
...
class WritePort:
    ...
    class Signature(wiring.Signature):
        ...
        * If :py:`shape` is :class:`data.ArrayLayout(_, elem_count) <.data.ArrayLayout>`,
        ...
        def create(self, *, path: tuple[str | int, ...] = ..., src_loc_at: int = ...): # -> WritePort:
            """:meta private:"""
            ...
