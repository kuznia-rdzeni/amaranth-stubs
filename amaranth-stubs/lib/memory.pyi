...
_T_ValueOrValueCastable = TypeVar("_T_ValueOrValueCastable", bound=Value | ValueCastable)
...
class Memory(wiring.Component, Generic[_T_ShapeLike, _T_ValueOrValueCastable]):
    ...
    @overload
    def __init__(self: Memory[ShapeCastable[_T_ValueOrValueCastable], _T_ValueOrValueCastable], data: Optional[MemoryData] = ..., *, shape: ShapeCastable[_T_ValueOrValueCastable] = ..., depth: Optional[int] = ..., init: Optional[Iterable[ValueLike]] = ..., attrs: Optional[dict[str, str]] = ..., src_loc_at: int = ...) -> None:
        ...

    @overload
    def __init__(self: Memory[_T_ShapeLike, Value], data: Optional[MemoryData] = ..., *, shape: _T_ShapeLike = ..., depth: Optional[int] = ..., init: Optional[Iterable[ValueLike]] = ..., attrs: Optional[dict[str, str]] = ..., src_loc_at: int = ...) -> None:
        ...

    def __init__(self, data: Optional[MemoryData] = ..., *, shape: Optional[ShapeLike] = ..., depth: Optional[int] = ..., init: Optional[Iterable[ValueLike]] = ..., attrs: Optional[dict[str, str]] = ..., src_loc_at: int = ...) -> None:
        ...
