...
class SwitchValue(Value):
    def __init__(self, test: ValueLike, cases: Iterable[tuple[SwitchKey | tuple[SwitchKey, ...] | None, ValueLike]], *, src_loc=None, src_loc_at=0) -> None:
        ...
...
class Signal(Value, DUID, metaclass=_SignalMeta):
    ...
    @overload
    @staticmethod
    def like(other: _T_ValueCastable, *, name: Optional[str] = ..., name_suffix: Optional[str] =..., src_loc_at=..., **kwargs) -> _T_ValueCastable:
        ...
