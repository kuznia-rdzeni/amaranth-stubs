...
from amaranth_types import HasElaborate, StatementLike, SwitchKey
from ._ast import *
...
def _guardedcontextmanager(
    keyword: str,
) -> Callable[[Callable[_P, Iterator[_T]]], Callable[_P, _GuardedContextManager[_T]]]: ...
